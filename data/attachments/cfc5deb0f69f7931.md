...
- Name: billPay\billPay.spec.js >> Bill Pay Module >> TC15 - Multiple Bill Payments
- Location: tests\billPay\billPay.spec.js:139:9

# Error details

```
Error: locator.click: Error: strict mode violation: locator('text=Bill Pay') resolved to 4 elements:
    1) <a href="billpay.htm">Bill Pay</a> aka getByRole('link', { name: 'Bill Pay' })
    2) <h1 class="title">Bill Payment Service</h1> aka getByRole('heading', { name: 'Bill Payment Service' })
    3) <h1 class="title">Bill Payment Complete</h1> aka getByText('Bill Payment Complete')
    4) <p>…</p> aka getByText('Bill Payment to in the amount')

Call log:
  - waiting for locator('text=Bill Pay')
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e54]:
          - rowgroup [ref=e55]:
            ...
            - row [ref=e98]:
              - cell [ref=e99]
            - 'row "Amount: $ 5000" [ref=e100]':
              - 'cell "Amount: $" [ref=e101]'
              - cell "5000" [ref=e102]:
                - textbox [ref=e103]: "5000"
              - cell [ref=e104]
            - row [ref=e105]:
              - cell [ref=e106]
            - 'row "From account #: 19671" [ref=e107]':
...
```ts
  ...
  4  |      constructor(page) {
  5  |           this.page = page;
  6  |           this.billPayLink = page.locator('text=Bill Pay');
  ...
  18 |           this.pageTitle = page.locator('h1.title');
  19 |      }
  20 | 
