...
- Name: registration\registration.spec.js >> Registration Module >> TC12 - Complete Registration Flow
- Location: tests\registration\registration.spec.js:195:10
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: user_p2y7v09hr6"':
      - cell "Username:"
      - cell "user_p2y7v09hr6":
        - textbox: user_p2y7v09hr6
      - cell
    - row "Password:":
      - cell "Password:"
      - cell:
