...
Call log:
  ...
  - waiting for locator('#rightPanel')
    12 × locator resolved to <div id="rightPanel">…</div>
       - unexpected value "
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: user1779709238891 This username already exists."':
      - cell "Username:"
      - cell "user1779709238891":
        - textbox: user1779709238891
