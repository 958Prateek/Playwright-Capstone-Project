...
- Location: tests\accountOverview\accountOverview.spec.js:87:9
    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - paragraph [ref=e53]:
          ...
          - link "61629" [ref=e54] [cursor=pointer]:
            - /url: activity.htm?id=61629
  - generic [ref=e56]:
    - list [ref=e57]:
      - listitem [ref=e58]:
...
> 88  |         const overview = new AccountOverviewPage(page);
  ...
  175 |         const overview = new AccountOverviewPage(page);
  176 |         await overview.gotoAccountsOverview();
  177 |         await overview.verifyAccountsOverviewPage();
  178 |         await overview.verifyBalancesVisible();
  179 |         await overview.verifyAccountNumbersVisible();
  180 |         console.log(' Complete Workflow Validated');
  181 |     });
  182 | 
  183 | 
  184 |     // PARALLEL EXECUTION
  185 |     // Executes tests in parallel if enabled
  186 | 
  187 |     test.describe.configure({
  188 |         mode: 'parallel'
```